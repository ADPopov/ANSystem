...
namespace ANSystem.View
{
    public partial class SpotsmanForm : Form
    {
        ...
        {
            Serialization.Save(SportsmanList, dataListBox);
        }


        private void DownloadMenuItem_Click(object sender, EventArgs e)
        {
            Serialization.Download(SportsmanList, dataListBox);
        }
        ...
        private void CloseToolStripMenuItem_Click(object sdender, EventArgs e)
        {
            Close();
        }
